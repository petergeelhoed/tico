...
/** @brief Make a filter for the given evalue and array length.
 *
...
/** @brief Fit the input array to the filter and return the total shift.
 *
...
/**@brief Convolute the input array with the given filter in the frequency
 * domain.
 *
...
/** @brief Get the maximum value from the given array in the frequency domain.
 *
